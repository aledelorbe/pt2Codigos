...
try:
    ...
    if contador == 1152: # 32 estado x 36 tipos de cancer = 1152 registros
        print(f'Se almacenaron correctamente los {contador} registros de estado con cancer.\n')
    ...
    if contador == 416: # 32 estado x 13 categorias de ocupacion = 1152 registros
        print(f'Se almacenaron correctamente los {contador} registros de estado con categoria de ocupacion.\n')
        # Guardar las inserciones realizadas.
        conn.commit()
    else:
    ...
    if contador == 320: # 32 estado x 10 niveles educativos = 320 registros
        print(f'Se almacenaron correctamente los {contador} registros de estado con niveles educativos.\n')
        # Guardar las inserciones realizadas.
        conn.commit()
    else:
